...
#define game_mode 0xFC6BEE8
namespace player_info
{
	constexpr auto local_index = 0x4E858;
	constexpr auto local_index_pos = 0x2d0;
	constexpr auto size = 0x6400;
	constexpr auto valid = 0x62ED;
	constexpr auto team_id = 0x3C6;
	constexpr auto position_ptr = 0x5720;
	constexpr auto stance = 0x50D8;
	constexpr auto recoil_offset = 0x74AC0;
	constexpr auto dead_1 = 0x5F68;
	constexpr auto dead_2 = 0x590;
...
namespace bones
{
	constexpr auto bone_base_pos = 0x2718;
	constexpr auto size = 0x188;
	constexpr auto visible = 0x2739EA0;
	constexpr auto weapon_definitions = 0x127A8530;
	//constexpr auto loot_ptr = 0x1EA6A3F0;
	constexpr auto distribute = 0xBC04B78;
}

namespace view_port
{
	constexpr auto refdef_ptr = 0x12E0CEC8;
	constexpr auto camera_ptr = 0x13443680;
...
namespace client
{
	...
	constexpr auto name_array = 0x12E2C210;
